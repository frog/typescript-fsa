...
export declare type Action<Payload> = {
    type: string;
    payload: Payload;
    error?: boolean;
    meta?: Meta;
...
export declare type Success<Params, Result> = Params extends void ? (Result extends void ? EmptyObject : {
    result: Result;
}) : (Result extends void ? {
    params: Params;
} : never) | {
...
export declare type Failure<Params, Error> = (Params extends void ? (Error extends void ? EmptyObject : {
    error: Error;
}) : (Error extends void ? {
    params: Params;
} : never) | {
...
export as namespace TypeScriptFSA;
